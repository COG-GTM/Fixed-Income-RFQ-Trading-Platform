...
public class SplitTheMonolithApplication implements CommandLineRunner {
	...
	/**
	 * Identifier of the counterparty seeded by the credit service.
	 */
	private static final long ACME_COUNTERPARTY_ID = 1L;
	...
	public void run(String... args) {
		...
		rfqRepository.save(new Rfq(ACME_COUNTERPARTY_ID, ustNote, new BigDecimal("5000000.00"),
