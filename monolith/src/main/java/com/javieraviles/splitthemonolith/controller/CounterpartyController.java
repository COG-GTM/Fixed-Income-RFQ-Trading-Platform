...
import com.javieraviles.splitthemonolith.confirmation.TradeConfirmationSender;
...
class CounterpartyController {
	...
	@Autowired
	private TradeConfirmationSender tradeConfirmationSender;
	...
	public ResponseEntity<?> partialUpdateGeneric(@RequestBody Map<String, String> creditUpdate,
		...
		try {
			...
			if (operation == OperationEnum.ADD) {
				...
				tradeConfirmationSender.sendTradeConfirmation(
						new TradeConfirmationDto(counterparty.getName(), creditAmount));
			} else {
